...
// INSER USER INTO THE DATABASE
                $insert_user = mysqli_query($db_connection, "INSERT INTO `users` (username, user_email,phone_number, user_password) VALUES ('$username', '$user_email',' $phone_number', '$user_hash_password')");
